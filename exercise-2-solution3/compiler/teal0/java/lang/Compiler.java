...
import lang.ir.IRFunction;
import lang.ir.IRCodeBB;
...
import lang.ir.MFP;
import lang.ir.Lattice;
import lang.ir.AbstractState;
...
public class Compiler {
	...
	public static boolean customASTAction(Program ast) {
		System.out.println("foo " + Compiler.class + "!");
	...
	public static boolean customIRAction(IRProgram ir) {
		// return "false" to finish here, otherwise the program will execute'
		//System.out.println("Nullness analysis " + Compiler.class + "!");
		MFP mfp = new MFP();
		Map<IRCodeBB, AbstractState> result = mfp.run(ir);
		mfp.print(result);
		return false;
	}
